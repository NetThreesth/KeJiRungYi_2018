...
(function (ContentType) {
    ...
    ContentType[ContentType["Algae"] = 2] = "Algae";
...
var MessageCenter = /** @class */ (function () {
    function MessageCenter(eventCenter) {
        ...
        _SocketClient__WEBPACK_IMPORTED_MODULE_0__["socketClient"].on('uploadDeepAlMessage', function (data) {
            _this.eventCenter.trigger(_components_DevPanel__WEBPACK_IMPORTED_MODULE_3__["AddLogEvent"], data);
            if (_GlobalData__WEBPACK_IMPORTED_MODULE_1__["GlobalData"].chatRoomIndex === data.rid)
    ...
    ;
    MessageCenter.prototype.addMessage = function (content, delay) {
        var _this = this;
        if (delay === void 0) { delay = 0; }
        setTimeout(function () {
            _this.contents.push(content);
            _this.eventCenter.trigger(MessageCenter.eventName);
        }, delay);
    };
    ;
...
var ControlPanel = /** @class */ (function (_super) {
    ...
    ControlPanel.prototype.render = function () {
        return react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: "control-panel invisible untouchable" },
            ...
            react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: "userRecord" },
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", null, "[ 3sth.net ]"),
                ...
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", null, _common_GlobalData__WEBPACK_IMPORTED_MODULE_3__["GlobalData"].userName),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", null,
                    "\u7E54\u884D\u6B72\u6578\uFF1A",
                    this.state.clientTime,
                    "\u6B72"),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", null,
                    "\u975E\u9810\u671F\u64FE\u52D5: ",
    ...
    ControlPanel.prototype.componentDidMount = function () {
        ...
        $(document).on('touchend click', function () {
            var touchEventCount = _this.state.touchEventCount + 1;
            _this.setState({ touchEventCount: touchEventCount });
            setTimeout(function () {
                _common_SocketClient__WEBPACK_IMPORTED_MODULE_1__["socketClient"].emit('updateUserInfo', __assign({ touchEventCount: touchEventCount }, _common_GlobalData__WEBPACK_IMPORTED_MODULE_3__["GlobalData"]));
            }, 0);
        });
        setInterval(function () {
            if (!_common_GlobalData__WEBPACK_IMPORTED_MODULE_3__["GlobalData"].signInTime)
                return;
            var newState = __assign({}, _this.state, { appTime: _this.getAppTime(), clientTime: _this.getClientTime() });
            _this.setState(newState);
        }, 200);
    };
    ;
    ControlPanel.prototype.getAppTime = function () {
        var ms = new Date().getTime() - new Date(2018, 8, 1).getTime();
        return this.btoa(ms / 1000);
    };
    ;
    ControlPanel.prototype.getClientTime = function () {
        var ms = new Date().getTime() - _common_GlobalData__WEBPACK_IMPORTED_MODULE_3__["GlobalData"].signInTime.getTime();
        return this.btoa(ms / 1000);
    };
    ;
    ControlPanel.prototype.btoa = function (num) {
    ...
    LoginPanel.prototype.render = function () {
        return react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { id: "loginPanel", onClick: this.focus.bind(this) },
            ...
            react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { id: "signInWrapper", className: "wordCard" },
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: "label text-center " }, "\u767B\u5165"),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("input", { type: "text", id: "signInName", placeholder: "\u4F7F\u7528\u8005\u540D\u7A31", value: this.state.signInName, onKeyPress: this.keyPress.bind(this), onChange: this.signInNameChanged.bind(this) }),
            ...
            react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: "skipAnimation" },
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("button", { type: "button", onClick: this.skipAnimation.bind(this) }, "\u8DF3\u904E\u52D5\u756B")));
    };
    ;
...
/* harmony import */ var _common_CommonUtility__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../common/CommonUtility */ "./app_src/common/CommonUtility.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var MessageBoard = /** @class */ (function (_super) {
    ...
    MessageBoard.prototype.createContent = function (content) {
        ...
        else if (content.type === _common_MessageCenter__WEBPACK_IMPORTED_MODULE_1__["ContentType"].Algae) {
            var algaes_1 = [];
            _common_CommonUtility__WEBPACK_IMPORTED_MODULE_5__["CommonUtility"].loop(content.algaeCount, function () {
                algaes_1.push(react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("img", { style: { height: '30px' }, src: '3sth/algae/algae_particle.png' }));
            });
            $content = react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: "content" }, algaes_1);
        }
        ...
        return react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { id: "projectInfo" },
            ...
            react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: "container", style: { display: 'none' } },
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: "content" },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("br", null),
                    react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("br", null),
                    react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("a", { target: "_blank", href: "https://aigaerithm.3sth.net/" }, "\u4E86\u89E3\u66F4\u591A"))));
    };
    ;
...
/* harmony import */ var _Scene_scss__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./Scene.scss */ "./app_src/components/Scene.scss");
...
var Scene = /** @class */ (function (_super) {
    ...
    function Scene() {
        ...
        _this.maskColor = { r: 0, g: 255, b: 0, a: 0.355 };
        _this.getTextureForParticle = function () {
            ...
            return function (color) {
                if (!textures) {
                    textures = {
                        pink: new babylonjs__WEBPACK_IMPORTED_MODULE_1__["Texture"]('3sth/particles/pink_particle.png', _this.scene),
                        white: new babylonjs__WEBPACK_IMPORTED_MODULE_1__["Texture"]('3sth/particles/white_particle.png', _this.scene),
                        yellow: new babylonjs__WEBPACK_IMPORTED_MODULE_1__["Texture"]('3sth/particles/yellow_particle.png', _this.scene)
                    };
    ...
    Scene.prototype.startUpdateBackgroundParticles = function () {
        var _this = this;
        _common_SocketClient__WEBPACK_IMPORTED_MODULE_3__["socketClient"].on('updateBackgroundParticles', function (dataForEachRoom) {
            dataForEachRoom.forEach(function (data, i) {
                _this.backgroundParticles[i].white.targetCount = data.white;
                _this.backgroundParticles[i].yellow.targetCount = data.yellow;
                _this.backgroundParticles[i].pink.targetCount = data.pink;
            });
        });
    };
    ;
    ...
    ;
    Scene.prototype.createBubbleSpray = function (position, bubbleCount) {
        if (this.bubbleSpray)
    ...
    Scene.prototype.createParticle = function (center, color) {
        var particle = babylonjs__WEBPACK_IMPORTED_MODULE_1__["Mesh"].CreatePlane("particle", 0.1, this.scene);
        ...
        var scaling = 0.1;
        particle.scaling = new babylonjs__WEBPACK_IMPORTED_MODULE_1__["Vector3"](scaling, scaling, scaling);
        return particle;
    };
    ;
            ...
            ['white', 'yellow', 'pink'].forEach(function (color) {
                ...
                if (count > 0) {
                    for (var i_1 = 0; i_1 < count; i_1++) {
                        var particle = _this.createParticle(center, color);
                    ...
                    var toScaleOutCount_1 = count * -1;
                    particlesForOneColor.particles.forEach(function (particle, i) {
                        if (i + 1 > toScaleOutCount_1)
                            return;
    ...
    Scene.prototype.translateParticles = function () {
        var _this = this;
        var particles = [];
        this.backgroundParticles.forEach(function (particlesForOneRoom) {
            ['white', 'yellow', 'pink'].forEach(function (color) {
        ...
        particles.forEach(function (p) {
            ...
            if (!p.scaleOut && p.mesh.scaling.x < 1) {
                var oldScale = p.mesh.scaling.x;
                var newScale = (oldScale > 0.95) ? 1 : (1 - oldScale) * 0.01 + oldScale;
                p.mesh.scaling = new babylonjs__WEBPACK_IMPORTED_MODULE_1__["Vector3"](newScale, newScale, newScale);
            }
            _common_BabylonUtility__WEBPACK_IMPORTED_MODULE_5__["BabylonUtility"].updatePosition(p.mesh.position, p.translateVector, 0.003);
            p.duration -= 1;
        });
    };
    ;
    ...
    Scene.prototype.getText = function () {
        ...
        var getTextNodes = function (img) {
            ...
            for (var i = 0; i < len; i += 4) {
                ...
                var rowNumber = Math.floor(pixelNumber / 64);
                var culNumber = pixelNumber % 64;
                pixels.push({
    ...
    ;
    Scene.prototype.setBackground = function () {
        var _this = this;
        jquery__WEBPACK_IMPORTED_MODULE_2__["get"]("/apis/getBaseline?rid=" + _common_GlobalData__WEBPACK_IMPORTED_MODULE_7__["GlobalData"].chatRoomIndex)
            .then(function (data) {
            _this.maskColor.a = 0.355 - (data.led / 1000);
            var center = _this.chatRoomsCenter[_common_GlobalData__WEBPACK_IMPORTED_MODULE_7__["GlobalData"].chatRoomIndex];
            _this.createBubbleSpray(center, data.pump);
        }).always(function () {
            _this.updateMask();
        });
    };
...
/* harmony import */ var _components_Scene__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/Scene */ "./app_src/components/Scene.tsx");
/* harmony import */ var _components_DevPanel__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/DevPanel */ "./app_src/components/DevPanel.tsx");
...
var App = function () { return (react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", null,
    react__WEBPACK_IMPORTED_MODULE_1__["createElement"](_components_Scene__WEBPACK_IMPORTED_MODULE_4__["Scene"], { eventCenter: eventCenter }),
