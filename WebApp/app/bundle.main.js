...
var Scene = /** @class */ (function (_super) {
    ...
    Scene.prototype.componentDidMount = function () {
        ...
        var updateMask = function () {
            var setting = _CommonUtility__WEBPACK_IMPORTED_MODULE_4__["CommonUtility"].getQueryString('greenMask');
            var color = setting || "rgba(0, 255, 0, " + _CommonUtility__WEBPACK_IMPORTED_MODULE_4__["CommonUtility"].getRandomNumberInRange(0, 0.5, 2) + ")";
            jquery__WEBPACK_IMPORTED_MODULE_3__('#greenMask').css('background-color', color);
            _this.props.eventCenter.trigger(_MessageCenter__WEBPACK_IMPORTED_MODULE_6__["Event"].UpdateDevPanelData, { greenMask: color });
            if (setting)
                return;
            setTimeout(function () {
                updateMask();
    ...
    Scene.prototype.createParticles = function () {
        ...
        this.chatRoomsCenter.forEach(function (center, i) {
            var count = _this.backgroundParticles[i].targetCount;
        ...
        jquery__WEBPACK_IMPORTED_MODULE_3__["getJSON"]('apis/getPoints', function (data) {
            ...
            Object.keys(data).forEach(function (key, i) {
                var pointInGroup = data[key].map(function (p) {
                    return new babylonjs__WEBPACK_IMPORTED_MODULE_1__["Vector3"](p.x, p.y, _CommonUtility__WEBPACK_IMPORTED_MODULE_4__["CommonUtility"].getRandomNumber(3) * 0.006);
                });
    ...
    Scene.prototype.cmdHandler = function (cmd) {
        ...
        algae.size = 1;
        algae.position.x = center.x + _CommonUtility__WEBPACK_IMPORTED_MODULE_4__["CommonUtility"].getRandomNumberInRange(-3, 3, 2);
        algae.position.y = center.y + _CommonUtility__WEBPACK_IMPORTED_MODULE_4__["CommonUtility"].getRandomNumberInRange(-3, 3, 2);
        algae.position.z = center.z + _CommonUtility__WEBPACK_IMPORTED_MODULE_4__["CommonUtility"].getRandomNumberInRange(-3, 3, 2);
    ...
    Scene.prototype.zoomIn = function () {
        Scene.chatRoomIndex = _CommonUtility__WEBPACK_IMPORTED_MODULE_4__["CommonUtility"].getRandomIntInRange(0, this.chatRoomsCenter.length - 1);
