...
var MessageCenter = /** @class */ (function () {
    ...
    MessageCenter.prototype.responseHandler = function (resp) {
        ...
        this.addMessage({ role: _GlobalData__WEBPACK_IMPORTED_MODULE_1__["Roles"].Algae, type: ContentType.Algae, algaeCount: resp.density / 10 });
...
var MessageBoard = /** @class */ (function (_super) {
    ...
    MessageBoard.prototype.createContent = function (content) {
        ...
        if (content.type === _common_MessageCenter__WEBPACK_IMPORTED_MODULE_1__["ContentType"].Text) {
            $content = react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: "content", style: { color: colors[content.role] } }, content.content);
        }
            ...
            _common_CommonUtility__WEBPACK_IMPORTED_MODULE_5__["CommonUtility"].loop(content.algaeCount, function () {
                algaes_1.push(react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("img", { src: '3sth/algae/algae_particle.png' }));
            });
...
/******/ });
//# sourceMappingURL=bundle.main.8e3e5c50a3133e5c117c.js.map